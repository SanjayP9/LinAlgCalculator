 ...
 * Used to get the size of both matricies. Fucntionality should be added so that this activity
 * recieves an intent message from main activity that specifies 1 or 2 matricies then this activty
 * creates sized entry based on message. Then based on that origianl message it should send that to
 * the grid view acticity so that it can tell if it needs to input another matrix. Should send size
